...
<!--  upd_sched.jsp shows the results of the request for listing the schedule for the certain EMPLOYEE on the certain DAY (show_sched_results.jsp) -->
<!--  upd_sched.jsp is included in show_sched_results.jsp -->
