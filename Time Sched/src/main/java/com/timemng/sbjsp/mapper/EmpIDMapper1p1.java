...
// EmpIDMapper - a mapper class (used for mapping corresponding to 1-1 between relationship between 1 column in the result of the query statement and 1 field in 
...
public class EmpIDMapper1p1 implements RowMapper<EmpIDInfo1p1> {
		...
		= "select emp_id from employee";  // @@@@@@@@@@@@@@@ , first_name, last_name
