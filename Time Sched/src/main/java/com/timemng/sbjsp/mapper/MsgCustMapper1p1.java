...
// MsgCustMapper1p1 - a mapper class (used for mapping corresponding to 1-1 between 1 column in the result of the query statement and 1 field in 
...
public class MsgCustMapper1p1 implements RowMapper<MsgCustInfo1p1> {   
	...
	= "insert into msgcust(person_id, message) values (";  
