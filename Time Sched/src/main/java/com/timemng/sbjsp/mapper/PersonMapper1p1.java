...
//PersonMapper - a mapper class (used for mapping corresponding to 1-1 between relationship between 1 column in the result of the query statement and 1 field in 
...
public class PersonMapper1p1  implements RowMapper<PersonInfo1p1> {
	...
	public static void resetSQL_EMP_NAME() {
		SQL_EMP_NAME = "select first_name, last_name from employee"; //  @@@@@@@@@@@@@@@ emp_id,
	}
