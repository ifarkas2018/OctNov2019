...
<html>
    ...
    <body onload="setDefaults()">
        ...
        <%
            ...
            String previous_title = (String)hSession2.getAttribute("prev_title"); // retrieving the title from the session variable ( update_page.jsp )
            ...
            if ( rset.next()) {
                ...
                au_name = rset.getString("au_name");
                ...
                publ_name = rset.getString("publ_name");
                publ_year = rset.getString("publ_year");
            }
